...
dict_variable_xaxis={
    "Pt1":"Leading jet transverse momentum [GeV]",
    "Pt2":"Sub-leading jet transverse momentum [GeV]",
...
def do_overlay():
    ...
    overlayHistograms(list_tuple_h1D,fileName=variablename,extensions="pdf",option="histo",addfitinfo=True,min_value=-1,max_value=-1,legend_info=[0.60,0.50,0.88,0.72,72,0.037,0],plot_option="HIST",text=("#bf{#it{#bf{ATLAS} Simulation Internal}}?#bf{#sqrt{s}=13 TeV}?#bf{b-tagged jet}",0.04,13,0.60,0.88,0.05),debug=False)
# done function
