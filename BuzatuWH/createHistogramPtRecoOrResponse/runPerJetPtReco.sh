InputFolder="${outputroot}/local/histo_PerJetPtReco_batch/readPaul_1_0_2BTag+TruthGENWZ_1_perjet"
Input="Minimum"
...
PhysicsMeaning="f"
Corrections="EMJESGSMu"
ListAllBins="Type_lep-1.5-B"
ListAllBins+="+PtV-90,120,160,200-B"
ListAllBins+="+Pt_EMJESGSMu-20,30,40,50,60,70,80,100,120,140,160,180,200,240,280-A"
Option="PerJetPtReco"
Debug=0
