...
if total!=9:
    ...
    print "Ex: python createHistogramPerJetPtReco.py inputFileName treeName NrEventStart NrEventEnd EventSelections ApplyEventWeights outputFileName debug"
    print "Ex: python createHistogramPerJetPtReco.py ${outputroot}/batch/readPaul_1_0_2BTag+GENWZ_1_perjet/lvbb125.root perjet 1 0 All,GENWZ 1,0 ${outputroot}/local/batch_histo/readPaul_1_0_2BTag+GENWZ_1_perjet/lvbb125.root 1" 
    assert(False)
# done if
...
# run
list_h1D=[]
list_h1D+=get_list_h1D("f","GENWZ","Pt","",(300,0,3),(1,0,0,1),("Jet transverse momentum correction factor",0.045,0.90),("Entries",0.045,0.95),list_corrections,debug)
...
list_bin.append(("Pt_EMJESGSMu",list_QBins))
