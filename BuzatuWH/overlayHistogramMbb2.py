...
#list_processes="llbb,STopWt,WqqZll,ZqqZll,ZeeMG,ZmumuMG".split(",")
...
for process in list_processes:
    for variation in list_variation:
        list_histogram=[
            ["inclusive","/Users/abuzatu/data/histos_mbb/"+date+"/histos_mbb_"+process+"_inclusive.root","",variation+"_mbb","",1],
            ["2had"     ,"/Users/abuzatu/data/histos_mbb/"+date+"/histos_mbb_"+process+"_2hadronic.root","",variation+"_mbb","",2],
            ["1had1sld" ,"/Users/abuzatu/data/histos_mbb/"+date+"/histos_mbb_"+process+"_1hadronic1semileptonic.root","",variation+"_mbb","",4],
            ["2sld"     ,"/Users/abuzatu/data/histos_mbb/"+date+"/histos_mbb_"+process+"_2semileptonic.root","",variation+"_mbb","",3],
        ]
        list_tuple_h1D=get_list_tuple_h1D()
        overlayHistograms(list_tuple_h1D,fileName="overlay_comparing_sld_"+process+"_"+variation,extensions="pdf",option="histo+Bukin",doValidationPlot=False,canvasname="canvasname",addHistogramInterpolate=False,addfitinfo=True,addMedianInFitInfo=False,min_value=-1,max_value=-1,min_value_ratio=-1,max_value_ratio=-1,statTitle="MC. stat uncertainty",statColor=6,ratioTitle="Ratio to first",legend_info=[0.37,0.50,0.48,0.72,72,0.030,0],plot_option="HIST",plot_option_ratio="HIST",text_option=("#bf{#it{#bf{ATLAS} Simulation Internal}}?#bf{#sqrt{s}=13 TeV}?#bf{"+process+"}?#bf{"+variation+"}",0.04,13,0.37,0.88,0.03),line_option=([0,0.5,1,0.5],2),debug=debug)
