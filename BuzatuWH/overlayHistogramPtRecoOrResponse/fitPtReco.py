...
options_fit="histo+Sigmoid" #"histo,Bukin,histo+Bukin,Gauss,Linear,Parabolic,Polynomial5"
# attempts unsuccessful, the PtReco distribution can not be fit easily, so only option is h.Interpolate()
...
list_category="nosld,mu,el".split(",")
#list_category="mu".split(",")
